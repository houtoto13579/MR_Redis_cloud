 ...
 * out-dir</b>
 */
public class SuffixSort extends Configured implements Tool {
	private static final Log LOG = LogFactory.getLog(SuffixSort.class);
	...
	static class TotalOrderPartitioner implements Partitioner<Text, Text> {
		...
		public void configure(JobConf job) {
			try {
				...
				trie = buildTrie(splitPoints, 0, splitPoints.length, new Text(),
						2);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(SuffixSort.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new JobConf(), new SuffixSort(), args);
		System.exit(res);
	}
